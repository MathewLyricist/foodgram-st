...
class TestFavorite(BaseTest):
    ...
    def test_add_again_to_favorite(
        ...
        """Проверяет невозможность повторного добавления в избранное."""
    ...
    def test_add_to_favorite_authorized(
        ...
        """Проверяет успешное добавление рецепта в избранное."""
    ...
    def test_delete_favorite_unauthorized(
        ...
        """Проверяет, что аноним не может удалить рецепт из избранного."""
    ...
    def test_delete_not_added_from_favorite(
        ...
        """Проверяет удаление не добавленного в избранное рецепта."""
        favorite = all_favorite[0]
    ...
    def test_delete_favorite(
        ...
        """Проверяет успешное удаление рецепта из избранного."""
        favorite = all_favorite[0]
